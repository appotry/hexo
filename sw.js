...
var cacheStorageKey = '17lai-cache-20230324045850';
// 在这个数组里面写入您主页加载需要的资源文件
var cacheList = [
  '/css/matery.css?v=1.0.1',
  '/css/my.css?v=1.0.0',
  '/css/post.css?v=1.0.0',
  '/css/reward.css?v=1.0.0',
  '/css/waline.css?v=1.0.0',
  ...
  '/libs/materialize/materialize.min.js?v=1.2.1 ',
  '/libs/materialize/materialize.min.css?v=1.2.1 ',
  '/libs/waline/waline.min.js?v=2.14.9',
  '/libs/waline/waline.min.css?v=2.14.9',
