if((navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i))) {
  ...
  //document.write('<canvas id="snowdown" style="position:fixed;top:0;left:0;width:100%;height:100%;z-index:100;pointer-events:none"></canvas>');
  ...
  window && (()=>{
    ...
    const i = document.getElementById("snowdown"), 
    n = i.getContext("2d"), 
    o = e.flakeCount;
    let a = -100, 
    d = -100, 
