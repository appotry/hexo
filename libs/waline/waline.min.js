...
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+Vn(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}},nr=new X;function Z(e,t){return nr.parse(e,t)}Z.options=Z.setOptions=function(e){return nr.setOptions(e),Z.defaults=nr.defaults,Ot(Z.defaults),Z},Z.getDefaults=Et,Z.defaults=Dt,Z.use=function(...e){return nr.use(...e),Z.defaults=nr.defaults,Ot(Z.defaults),Z},Z.walkTokens=function(e,t){return nr.walkTokens(e,t)},Z.parseInline=nr.parseInline,Z.Parser=er,Z.parser=er.parse,Z.Renderer=Qn,Z.TextRenderer=$n,Z.Lexer=Zn,Z.lexer=Zn.lex,Z.Tokenizer=Xn,Z.Hooks=tr,Z.parse=Z,Z.options,Z.setOptions,Z.use,Z.walkTokens,Z.parseInline,er.parse,Zn.lex;function rr(e){if(typeof e==`function`&&(e={highlight:e}),!e||typeof e.highlight!=`function`)throw Error(`Must provide highlight function`);return typeof e.langPrefix!=`string`&&(e.langPrefix=`language-`),typeof e.emptyLangClass!=`string`&&(e.emptyLangClass=``),{async:!!e.async,walkTokens(t){if(t.type!==`code`)return;let n=ir(t.lang);if(e.async)return Promise.resolve(e.highlight(t.text,n,t.lang||``)).then(ar(t));let r=e.highlight(t.text,n,t.lang||``);if(r instanceof Promise)throw Error(`markedHighlight is not set to async but the highlight function is async. Set the async option to true on markedHighlight to await the async highlight function.`);ar(t)(r)},useNewRenderer:!0,renderer:{code(t,n,r){typeof t==`object`&&(r=t.escaped,n=t.lang,t=t.text);let i=ir(n),a=i?e.langPrefix+fr(i):e.emptyLangClass,o=a?` class="${a}"`:``;return t=t.replace(/\n$/,``),`<pre><code${o}>${r?t:fr(t,!0)}\n</code></pre>`}}}}function ir(e){return(e||``).match(/\S*/)[0]}function ar(e){return t=>{typeof t==`string`&&t!==e.text&&(e.escaped=!0,e.text=t)}}const or=/[&<>"']/,sr=new RegExp(or.source,`g`),cr=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,lr=new RegExp(cr.source,`g`),ur={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},dr=e=>ur[e];function fr(e,t){if(t){if(or.test(e))return e.replace(sr,dr)}else if(cr.test(e))return e.replace(lr,dr);return e}const pr=/\$.*?\$/u,mr=/^\$(.*?)\$/u,hr=/^(?:\s{0,3})\$\$((?:[^\n]|\n[^\n])+?)\n{0,1}\$\$/u,gr=e=>[{name:`blockMath`,level:`block`,tokenizer(t){let n=hr.exec(t);if(n!=null)return{type:`html`,raw:n[0],text:e(!0,n[1])}}},{name:`inlineMath`,level:`inline`,start(e){let t=e.search(pr);return t===-1?e.length:t},tokenizer(t){let n=mr.exec(t);if(n!=null)return{type:`html`,raw:n[0],text:e(!1,n[1])}}}],_r=(e=``,t={})=>e.replaceAll(/:(.+?):/gu,(e,n)=>t[n]?`<img class="wl-emoji" src="${t[n]}" alt="${n}">`:e),vr=(e,{emojiMap:t,highlighter:n,texRenderer:r})=>{let i=new X;if(i.setOptions({breaks:!0}),n&&i.use(rr({highlight:n})),r){let e=gr(r);i.use({extensions:e})}return i.parse(_r(e,t))},yr=e=>{let{path:t}=e.dataset;return t?.length?t:null},br=e=>e.match(/[\w\d\s,.\u00C0-\u024F\u0400-\u04FF]+/giu),xr=e=>e.match(/[\u4E00-\u9FD5]/gu),Sr=e=>(br(e)?.reduce((e,t)=>e+([``,`,`,`.`].includes(t.trim())?0:t.trim().split(/\s+/u).length),0)??0)+(xr(e)?.length??0),Cr=async()=>{let{userAgentData:e}=navigator,t=navigator.userAgent;if(e?.platform!==`Windows`)return t;let{platformVersion:n}=await e.getHighEntropyValues([`platformVersion`]);return n&&Number.parseInt(n.split(`.`)[0],10)>=13&&(t=t.replace(`Windows NT 10.0`,`Windows NT 11.0`)),t},wr=({serverURL:e,path:t=window.location.pathname,selector:n=`.waline-comment-count`,lang:r=navigator.language})=>{let i=new AbortController,a=document.querySelectorAll(n);return a.length>0&&b({serverURL:be(e),paths:Array.from(a,e=>_e(yr(e)??t)),lang:r,signal:i.signal}).then(e=>{a.forEach((t,n)=>{t.textContent=e[n].toString()})}).catch(Ct),i.abort.bind(i)},Tr=()=>ft(`WALINE_USER_META`,{nick:``,mail:``,link:``}),Er=()=>ft(`WALINE_COMMENT_BOX_EDITOR`,``),Q=ft(`WALINE_LIKE`,[]),Dr=()=>Q,Or=ft(`WALINE_REACTION`,{}),kr=()=>Or;var Ar=o((e=>{var t=e&&e.__awaiter||function(e,t,n,r){function i(e){return e instanceof n?e:new n(function(t){t(e)})}return new(n||=Promise)(function(n,a){function o(e){try{c(r.next(e))}catch(e){a(e)}}function s(e){try{c(r.throw(e))}catch(e){a(e)}}function c(e){e.done?n(e.value):i(e.value).then(o,s)}c((r=r.apply(e,t||[])).next())})},n=e&&e.__generator||function(e,t){var n={label:0,sent:function(){if(a[0]&1)throw a[1];return a[1]},trys:[],ops:[]},r,i,a,o;return o={next:s(0),throw:s(1),return:s(2)},typeof Symbol==`function`&&(o[Symbol.iterator]=function(){return this}),o;function s(e){return function(t){return c([e,t])}}function c(s){if(r)throw TypeError(`Generator is already executing.`);for(;o&&(o=0,s[0]&&(n=0)),n;)try{if(r=1,i&&(a=s[0]&2?i.return:s[0]?i.throw||((a=i.return)&&a.call(i),0):i.next)&&!(a=a.call(i,s[1])).done)return a;switch(i=0,a&&(s=[s[0]&2,a.value]),s[0]){case 0:case 1:a=s;break;case 4:return n.label++,{value:s[1],done:!1};case 5:n.label++,i=s[1],s=[0];continue;case 7:s=n.ops.pop(),n.trys.pop();continue;default:if((a=n.trys,!(a=a.length>0&&a[a.length-1]))&&(s[0]===6||s[0]===2)){n=0;continue}if(s[0]===3&&(!a||s[1]>a[0]&&s[1]<a[3])){n.label=s[1];break}if(s[0]===6&&n.label<a[1]){n.label=a[1],a=s;break}if(a&&n.label<a[2]){n.label=a[2],n.ops.push(s);break}a[2]&&n.ops.pop(),n.trys.pop();continue}s=t.call(e,n)}catch(e){s=[6,e],i=0}finally{r=a=0}if(s[0]&5)throw s[1];return{value:s[0]?s[1]:void 0,done:!0}}};Object.defineProperty(e,"__esModule",{value:!0}),e.ReCaptchaInstance=void 0,e.ReCaptchaInstance=function(){function e(e,t,n){this.siteKey=e,this.recaptchaID=t,this.recaptcha=n,this.styleContainer=null}return e.prototype.execute=function(e){return t(this,void 0,void 0,function(){var t;return n(this,function(n){switch(n.label){case 0:return this.recaptcha.enterprise?[4,this.recaptcha.enterprise.execute(this.recaptchaID,{action:e})]:[3,2];case 1:return t=n.sent(),[3,4];case 2:return[4,this.recaptcha.execute(this.recaptchaID,{action:e})];case 3:t=n.sent(),n.label=4;case 4:return[2,t]}})})},e.prototype.getSiteKey=function(){return this.siteKey},e.prototype.hideBadge=function(){this.styleContainer===null&&(this.styleContainer=document.createElement(`style`),this.styleContainer.innerHTML=`.grecaptcha-badge{visibility:hidden !important;}`,document.head.appendChild(this.styleContainer))},e.prototype.showBadge=function(){this.styleContainer!==null&&(document.head.removeChild(this.styleContainer),this.styleContainer=null)},e}()})),jr=o((e=>{var t=e&&e.__assign||function(){return t=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var i in t=arguments[n],t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e},t.apply(this,arguments)};Object.defineProperty(e,"__esModule",{value:!0}),e.getInstance=e.load=void 0;var n=Ar(),r;(function(e){e[e.NOT_LOADED=0]=`NOT_LOADED`,e[e.LOADING=1]=`LOADING`,e[e.LOADED=2]=`LOADED`})(r||={});var i=function(){function e(){}return e.load=function(t,i){if(i===void 0&&(i={}),typeof document>`u`)return Promise.reject(Error(`This is a library for the browser!`));if(e.getLoadingState()===r.LOADED)return e.instance.getSiteKey()===t?Promise.resolve(e.instance):Promise.reject(Error(`reCAPTCHA already loaded with different site key!`));if(e.getLoadingState()===r.LOADING)return t===e.instanceSiteKey?new Promise(function(t,n){e.successfulLoadingConsumers.push(function(e){return t(e)}),e.errorLoadingRunnable.push(function(e){return n(e)})}):Promise.reject(Error(`reCAPTCHA already loaded with different site key!`));e.instanceSiteKey=t,e.setLoadingState(r.LOADING);var a=new e;return new Promise(function(o,s){a.loadScript(t,i.useRecaptchaNet||!1,i.useEnterprise||!1,i.renderParameters?i.renderParameters:{},i.customUrl).then(function(){e.setLoadingState(r.LOADED);var s=a.doExplicitRender(grecaptcha,t,i.explicitRenderParameters?i.explicitRenderParameters:{},i.useEnterprise||!1),c=new n.ReCaptchaInstance(t,s,grecaptcha);e.successfulLoadingConsumers.forEach(function(e){return e(c)}),e.successfulLoadingConsumers=[],i.autoHideBadge&&c.hideBadge(),e.instance=c,o(c)}).catch(function(t){e.errorLoadingRunnable.forEach(function(e){return e(t)}),e.errorLoadingRunnable=[],s(t)})})},e.getInstance=function(){return e.instance},e.setLoadingState=function(t){e.loadingState=t},e.getLoadingState=function(){return e.loadingState===null?r.NOT_LOADED:e.loadingState},e.prototype.loadScript=function(t,n,i,a,o){var s=this;n===void 0&&(n=!1),i===void 0&&(i=!1),a===void 0&&(a={}),o===void 0&&(o=``);var c=document.createElement(`script`);c.setAttribute(`recaptcha-v3-script`,``),c.setAttribute(`async`,``),c.setAttribute(`defer`,``);var l=`https://www.google.com/recaptcha/api.js`;n?l=i?`https://recaptcha.net/recaptcha/enterprise.js`:`https://recaptcha.net/recaptcha/api.js`:i&&(l=`https://www.google.com/recaptcha/enterprise.js`),o&&(l=o),a.render&&=void 0;var u=this.buildQueryString(a);return c.src=l+`?render=explicit`+u,new Promise(function(t,n){c.addEventListener(`load`,s.waitForScriptToLoad(function(){t(c)},i),!1),c.onerror=function(t){e.setLoadingState(r.NOT_LOADED),n(t)},document.head.appendChild(c)})},e.prototype.buildQueryString=function(e){return Object.keys(e).length<1?``:`&`+Object.keys(e).filter(function(t){return!!e[t]}).map(function(t){return t+`=`+e[t]}).join(`&`)},e.prototype.waitForScriptToLoad=function(t,n){var r=this;return function(){window.grecaptcha===void 0?setTimeout(function(){r.waitForScriptToLoad(t,n)},e.SCRIPT_LOAD_DELAY):n?window.grecaptcha.enterprise.ready(function(){t()}):window.grecaptcha.ready(function(){t()})}},e.prototype.doExplicitRender=function(e,n,r,i){var a=t({sitekey:n},r);return r.container?i?e.enterprise.render(r.container,a):e.render(r.container,a):i?e.enterprise.render(a):e.render(a)},e.loadingState=null,e.instance=null,e.instanceSiteKey=null,e.successfulLoadingConsumers=[],e.errorLoadingRunnable=[],e.SCRIPT_LOAD_DELAY=25,e}();e.load=i.load,e.getInstance=i.getInstance})),Mr=o((e=>{Object.defineProperty(e,"__esModule",{value:!0}),e.ReCaptchaInstance=e.getInstance=e.load=void 0;var t=jr();Object.defineProperty(e,"load",{enumerable:!0,get:function(){return t.load}}),Object.defineProperty(e,"getInstance",{enumerable:!0,get:function(){return t.getInstance}});var n=Ar();Object.defineProperty(e,"ReCaptchaInstance",{enumerable:!0,get:function(){return n.ReCaptchaInstance}})}))();const Nr={},Pr=e=>{let t=Nr[e]??=(0,Mr.load)(e,{useRecaptchaNet:!0,autoHideBadge:!0});return{execute:e=>t.then(t=>t.execute(e))}},Fr=e=>({execute:async t=>{let{load:n}=ht(`https://challenges.cloudflare.com/turnstile/v0/api.js`,void 0,{async:!1});await n();let{turnstile:r}=window;return new Promise(n=>{r?.ready(()=>{r.render(`.wl-captcha-container`,{sitekey:e,action:t,size:`compact`,callback:n})})})}}),Ir=ft(`WALINE_USER`,{}),Lr=()=>Ir,Rr=`3.15.1`,zr=({size:e})=>(0,U.h)(`svg`,{class:`wl-close-icon`,viewBox:`0 0 1024 1024`,width:e,height:e},[(0,U.h)(`path`,{d:`M697.173 85.333h-369.92c-144.64 0-241.92 101.547-241.92 252.587v348.587c0 150.613 97.28 252.16 241.92 252.16h369.92c144.64 0 241.494-101.547 241.494-252.16V337.92c0-151.04-96.854-252.587-241.494-252.587z`,fill:`currentColor`}),(0,U.h)(`path`,{d:`m640.683 587.52-75.947-75.861 75.904-75.862a37.29 37.29 0 0 0 0-52.778 37.205 37.205 0 0 0-52.779 0l-75.946 75.818-75.862-75.946a37.419 37.419 0 0 0-52.821 0 37.419 37.419 0 0 0 0 52.821l75.947 75.947-75.776 75.733a37.29 37.29 0 1 0 52.778 52.821l75.776-75.776 75.947 75.947a37.376 37.376 0 0 0 52.779-52.821z`,fill:`#888`})]),Br=()=>(0,U.h)(`svg`,{viewBox:`0 0 1024 1024`,width:`24`,height:`24`},(0,U.h)(`path`,{d:`m341.013 394.667 27.755 393.45h271.83l27.733-393.45h64.106l-28.01 397.952a64 64 0 0 1-63.83 59.498H368.768a64 64 0 0 1-63.83-59.52l-28.053-397.93h64.128zm139.307 19.818v298.667h-64V414.485h64zm117.013 0v298.667h-64V414.485h64zM181.333 288h640v64h-640v-64zm453.483-106.667v64h-256v-64h256z`,fill:`red`})),Vr=()=>(0,U.h)(`svg`,{viewBox:`0 0 1024 1024`,width:`24`,height:`24`},(0,U.h)(`path`,{d:`M563.2 463.3 677 540c1.7 1.2 3.7 1.8 5.8 1.8.7 0 1.4-.1 2-.2 2.7-.5 5.1-2.1 6.6-4.4l25.3-37.8c1.5-2.3 2.1-5.1 1.6-7.8s-2.1-5.1-4.4-6.6l-73.6-49.1 73.6-49.1c2.3-1.5 3.9-3.9 4.4-6.6.5-2.7 0-5.5-1.6-7.8l-25.3-37.8a10.1 10.1 0 0 0-6.6-4.4c-.7-.1-1.3-.2-2-.2-2.1 0-4.1.6-5.8 1.8l-113.8 76.6c-9.2 6.2-14.7 16.4-14.7 27.5.1 11 5.5 21.3 14.7 27.4zM387 348.8h-45.5c-5.7 0-10.4 4.7-10.4 10.4v153.3c0 5.7 4.7 10.4 10.4 10.4H387c5.7 0 10.4-4.7 10.4-10.4V359.2c0-5.7-4.7-10.4-10.4-10.4zm333.8 241.3-41-20a10.3 10.3 0 0 0-8.1-.5c-2.6.9-4.8 2.9-5.9 5.4-30.1 64.9-93.1 109.1-164.4 115.2-5.7.5-9.9 5.5-9.5 11.2l3.9 45.5c.5 5.3 5 9.5 10.3 9.5h.9c94.8-8 178.5-66.5 218.6-152.7 2.4-5 .3-11.2-4.8-13.6zm186-186.1c-11.9-42-30.5-81.4-55.2-117.1-24.1-34.9-53.5-65.6-87.5-91.2-33.9-25.6-71.5-45.5-111.6-59.2-41.2-14-84.1-21.1-127.8-21.1h-1.2c-75.4 0-148.8 21.4-212.5 61.7-63.7 40.3-114.3 97.6-146.5 165.8-32.2 68.1-44.3 143.6-35.1 218.4 9.3 74.8 39.4 145 87.3 203.3.1.2.3.3.4.5l36.2 38.4c1.1 1.2 2.5 2.1 3.9 2.6 73.3 66.7 168.2 103.5 267.5 103.5 73.3 0 145.2-20.3 207.7-58.7 37.3-22.9 70.3-51.5 98.1-85 27.1-32.7 48.7-69.5 64.2-109.1 15.5-39.7 24.4-81.3 26.6-123.8 2.4-43.6-2.5-87-14.5-129zm-60.5 181.1c-8.3 37-22.8 72-43 104-19.7 31.1-44.3 58.6-73.1 81.7-28.8 23.1-61 41-95.7 53.4-35.6 12.7-72.9 19.1-110.9 19.1-82.6 0-161.7-30.6-222.8-86.2l-34.1-35.8c-23.9-29.3-42.4-62.2-55.1-97.7-12.4-34.7-18.8-71-19.2-107.9-.4-36.9 5.4-73.3 17.1-108.2 12-35.8 30-69.2 53.4-99.1 31.7-40.4 71.1-72 117.2-94.1 44.5-21.3 94-32.6 143.4-32.6 49.3 0 97 10.8 141.8 32 34.3 16.3 65.3 38.1 92 64.8 26.1 26 47.5 56 63.6 89.2 16.2 33.2 26.6 68.5 31 105.1 4.6 37.5 2.7 75.3-5.6 112.3z`,fill:`currentColor`})),Hr=()=>(0,U.h)(`svg`,{viewBox:`0 0 1024 1024`,width:`24`,height:`24`},[(0,U.h)(`path`,{d:`M784 112H240c-88 0-160 72-160 160v480c0 88 72 160 160 160h544c88 0 160-72 160-160V272c0-88-72-160-160-160zm96 640c0 52.8-43.2 96-96 96H240c-52.8 0-96-43.2-96-96V272c0-52.8 43.2-96 96-96h544c52.8 0 96 43.2 96 96v480z`,fill:`currentColor`}),(0,U.h)(`path`,{d:`M352 480c52.8 0 96-43.2 96-96s-43.2-96-96-96-96 43.2-96 96 43.2 96 96 96zm0-128c17.6 0 32 14.4 32 32s-14.4 32-32 32-32-14.4-32-32 14.4-32 32-32zm462.4 379.2-3.2-3.2-177.6-177.6c-25.6-25.6-65.6-25.6-91.2 0l-80 80-36.8-36.8c-25.6-25.6-65.6-25.6-91.2 0L200 728c-4.8 6.4-8 14.4-8 24 0 17.6 14.4 32 32 32 9.6 0 16-3.2 22.4-9.6L380.8 640l134.4 134.4c6.4 6.4 14.4 9.6 24 9.6 17.6 0 32-14.4 32-32 0-9.6-4.8-17.6-9.6-24l-52.8-52.8 80-80L769.6 776c6.4 4.8 12.8 8 20.8 8 17.6 0 32-14.4 32-32 0-8-3.2-16-8-20.8z`,fill:`currentColor`})]),$=({active:e=!1})=>(0,U.h)(`svg`,{viewBox:`0 0 1024 1024`,width:`24`,height:`24`},[(0,U.h)(`path`,{d:`M850.654 323.804c-11.042-25.625-26.862-48.532-46.885-68.225-20.022-19.61-43.258-34.936-69.213-45.73-26.78-11.124-55.124-16.727-84.375-16.727-40.622 0-80.256 11.123-114.698 32.135A214.79 214.79 0 0 0 512 241.819a214.79 214.79 0 0 0-23.483-16.562c-34.442-21.012-74.076-32.135-114.698-32.135-29.25 0-57.595 5.603-84.375 16.727-25.872 10.711-49.19 26.12-69.213 45.73-20.105 19.693-35.843 42.6-46.885 68.225-11.453 26.615-17.303 54.877-17.303 83.963 0 27.439 5.603 56.03 16.727 85.117 9.31 24.307 22.659 49.52 39.715 74.981 27.027 40.293 64.188 82.316 110.33 124.915 76.465 70.615 152.189 119.394 155.402 121.371l19.528 12.525c8.652 5.52 19.776 5.52 28.427 0l19.529-12.525c3.213-2.06 78.854-50.756 155.401-121.371 46.143-42.6 83.304-84.622 110.33-124.915 17.057-25.46 30.487-50.674 39.716-74.981 11.124-29.087 16.727-57.678 16.727-85.117.082-29.086-5.768-57.348-17.221-83.963z${e?``:`M512 761.5S218.665 573.55 218.665 407.767c0-83.963 69.461-152.023 155.154-152.023 60.233 0 112.473 33.618 138.181 82.727 25.708-49.109 77.948-82.727 138.18-82.727 85.694 0 155.155 68.06 155.155 152.023C805.335 573.551 512 761.5 512 761.5z`}`,fill:e?`red`:`currentColor`})]),Ur=()=>(0,U.h)(`svg`,{viewBox:`0 0 1024 1024`,width:`24`,height:`24`},[(0,U.h)(`path`,{d:`M710.816 654.301c70.323-96.639 61.084-230.578-23.705-314.843-46.098-46.098-107.183-71.109-172.28-71.109-65.008 0-126.092 25.444-172.28 71.109-45.227 46.098-70.756 107.183-70.756 172.106 0 64.923 25.444 126.007 71.194 172.106 46.099 46.098 107.184 71.109 172.28 71.109 51.414 0 100.648-16.212 142.824-47.404l126.53 126.006c7.058 7.06 16.297 10.979 26.406 10.979 10.105 0 19.343-3.919 26.402-10.979 14.467-14.467 14.467-38.172 0-52.723L710.816 654.301zm-315.107-23.265c-65.88-65.88-65.88-172.54 0-238.42 32.069-32.07 74.245-49.149 119.471-49.149 45.227 0 87.407 17.603 119.472 49.149 65.88 65.879 65.88 172.539 0 238.42-63.612 63.178-175.242 63.178-238.943 0zm0 0`,fill:`currentColor`}),(0,U.h)(`path`,{d:`M703.319 121.603H321.03c-109.8 0-199.469 89.146-199.469 199.38v382.034c0 109.796 89.236 199.38 199.469 199.38h207.397c20.653 0 37.384-16.645 37.384-37.299 0-20.649-16.731-37.296-37.384-37.296H321.03c-68.582 0-124.352-55.77-124.352-124.267V321.421c0-68.496 55.77-124.267 124.352-124.267h382.289c68.582 0 124.352 55.771 124.352 124.267V524.72c0 20.654 16.736 37.299 37.385 37.299 20.654 0 37.384-16.645 37.384-37.299V320.549c-.085-109.8-89.321-198.946-199.121-198.946zm0 0`,fill:`currentColor`})]),Wr=()=>(0,U.h)(`svg`,{width:`16`,height:`16`,ariaHidden:`true`},(0,U.h)(`path`,{d:`M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z`,fill:`currentColor`})),Gr=()=>(0,U.h)(`svg`,{viewBox:`0 0 1024 1024`,width:`24`,height:`24`},(0,U.h)(`path`,{d:`M810.667 213.333a64 64 0 0 1 64 64V704a64 64 0 0 1-64 64H478.336l-146.645 96.107a21.333 21.333 0 0 1-33.024-17.856V768h-85.334a64 64 0 0 1-64-64V277.333a64 64 0 0 1 64-64h597.334zm0 64H213.333V704h149.334v63.296L459.243 704h351.424V277.333zm-271.36 213.334v64h-176.64v-64h176.64zm122.026-128v64H362.667v-64h298.666z`,fill:`currentColor`})),Kr=()=>(0,U.h)(`svg`,{viewBox:`0 0 1024 1024`,width:`24`,height:`24`},(0,U.h)(`path`,{d:`M813.039 318.772L480.53 651.278H360.718V531.463L693.227 198.961C697.904 194.284 704.027 192 710.157 192C716.302 192 722.436 194.284 727.114 198.961L813.039 284.88C817.72 289.561 820 295.684 820 301.825C820 307.95 817.72 314.093 813.039 318.772ZM710.172 261.888L420.624 551.431V591.376H460.561L750.109 301.825L710.172 261.888ZM490.517 291.845H240.906V771.09H720.156V521.479C720.156 504.947 733.559 491.529 750.109 491.529C766.653 491.529 780.063 504.947 780.063 521.479V791.059C780.063 813.118 762.18 831 740.125 831H220.937C198.882 831 181 813.118 181 791.059V271.872C181 249.817 198.882 231.935 220.937 231.935H490.517C507.06 231.935 520.47 245.352 520.47 261.888C520.47 278.424 507.06 291.845 490.517 291.845Z`,fill:`currentColor`})),qr=()=>(0,U.h)(`svg`,{class:`verified-icon`,viewBox:`0 0 1024 1024`,width:`14`,height:`14`},(0,U.h)(`path`,{d:`m894.4 461.56-54.4-63.2c-10.4-12-18.8-34.4-18.8-50.4v-68c0-42.4-34.8-77.2-77.2-77.2h-68c-15.6 0-38.4-8.4-50.4-18.8l-63.2-54.4c-27.6-23.6-72.8-23.6-100.8 0l-62.8 54.8c-12 10-34.8 18.4-50.4 18.4h-69.2c-42.4 0-77.2 34.8-77.2 77.2v68.4c0 15.6-8.4 38-18.4 50l-54 63.6c-23.2 27.6-23.2 72.4 0 100l54 63.6c10 12 18.4 34.4 18.4 50v68.4c0 42.4 34.8 77.2 77.2 77.2h69.2c15.6 0 38.4 8.4 50.4 18.8l63.2 54.4c27.6 23.6 72.8 23.6 100.8 0l63.2-54.4c12-10.4 34.4-18.8 50.4-18.8h68c42.4 0 77.2-34.8 77.2-77.2v-68c0-15.6 8.4-38.4 18.8-50.4l54.4-63.2c23.2-27.6 23.2-73.2-.4-100.8zm-216-25.2-193.2 193.2a30 30 0 0 1-42.4 0l-96.8-96.8a30.16 30.16 0 0 1 0-42.4c11.6-11.6 30.8-11.6 42.4 0l75.6 75.6 172-172c11.6-11.6 30.8-11.6 42.4 0 11.6 11.6 11.6 30.8 0 42.4z`,fill:`#27ae60`})),Jr=()=>(0,U.h)(`svg`,{class:`administrator-icon`,viewBox:`0 0 1024 1024`,width:`14`,height:`14`},[(0,U.h)(`path`,{d:`M461.6 129.56C489.6 105.96 534.8 105.96 562.4 129.56L625.6 183.96C637.6 194.36 660.4 202.76 676 202.76H744C786.4 202.76 821.2 237.56 821.2 279.96V347.96C821.2 363.96 829.6 386.36 840 398.36L894.4 461.56C918 489.16 918 534.76 894.8 562.36L840.4 625.56C830 637.56 821.6 660.36 821.6 675.96V743.96C821.6 786.36 786.8 821.16 744.4 821.16H676.4C660.4 821.16 638 829.56 626 839.96L562.8 894.36C534.8 917.96 489.6 917.96 462 894.36L398.8 839.96C386.8 829.56 364 821.16 348.4 821.16H279.2C236.8 821.16 202 786.36 202 743.96V675.56C201.999 659.96 193.6 637.56 183.6 625.56L129.6 561.96C106.4 534.36 106.4 489.56 129.6 461.96L183.6 398.36C193.6 386.359 202 363.959 202 348.36V279.96C202 237.56 236.8 202.76 279.2 202.76H348.4C364 202.76 386.8 194.36 398.8 184.36L461.6 129.56ZM549.567 331.896C530.047 303.082 486.645 306.12 471.433 337.412L442.175 396.526C435.587 409.848 422.856 419.097 408.146 421.226L342.706 430.726C340.776 431 338.884 431.397 336.993 431.946C303.482 441.361 292.756 483.493 317.671 507.812L364.975 553.96C375.623 564.321 380.507 579.299 377.991 593.954L366.917 659.102C366.595 661.03 366.355 662.967 366.279 664.923C364.906 699.688 401.683 722.937 432.514 706.738L491.05 675.966C504.217 669.068 519.954 669.069 533.121 675.966L591.675 706.738C593.406 707.645 595.174 708.432 597.028 709.104C629.666 721.205 663.139 693.382 657.273 659.102L646.069 593.954C643.42 579.176 648.24 564.083 659.001 553.6L706.315 507.461C707.687 506.118 708.994 504.66 710.215 503.127C731.779 475.809 715.737 435.41 681.281 430.365L615.839 420.874C601.13 418.745 588.4 409.486 581.821 396.174L552.562 337.052C551.644 335.284 550.674 333.551 549.567 331.896Z`,fill:`#f59831`})]),Yr=({size:e=100})=>(0,U.h)(`svg`,{width:e,height:e,viewBox:`0 0 100 100`,preserveAspectRatio:`xMidYMid`},(0,U.h)(`circle`,{cx:50,cy:50,fill:`none`,stroke:`currentColor`,strokeWidth:`4`,r:`40`,"stroke-dasharray":`85 30`},(0,U.h)(`animateTransform`,{attributeName:`transform`,type:`rotate`,repeatCount:`indefinite`,dur:`1s`,values:`0 50 50;360 50 50`,keyTimes:`0;1`}))),Xr=()=>(0,U.h)(`svg`,{width:24,height:24,fill:`currentcolor`,viewBox:`0 0 24 24`},[(0,U.h)(`path`,{style:`transform: translateY(0.5px)`,d:`M18.968 10.5H15.968V11.484H17.984V12.984H15.968V15H14.468V9H18.968V10.5V10.5ZM8.984 9C9.26533 9 9.49967 9.09367 9.687 9.281C9.87433 9.46833 9.968 9.70267 9.968 9.984V10.5H6.499V13.5H8.468V12H9.968V14.016C9.968 14.2973 9.87433 14.5317 9.687 14.719C9.49967 14.9063 9.26533 15 8.984 15H5.984C5.70267 15 5.46833 14.9063 5.281 14.719C5.09367 14.5317 5 14.2973 5 14.016V9.985C5 9.70367 5.09367 9.46933 5.281 9.282C5.46833 9.09467 5.70267 9.001 5.984 9.001H8.984V9ZM11.468 9H12.968V15H11.468V9V9Z`}),(0,U.h)(`path`,{d:`M18.5 3H5.75C3.6875 3 2 4.6875 2 6.75V18C2 20.0625 3.6875 21.75 5.75 21.75H18.5C20.5625 21.75 22.25 20.0625 22.25 18V6.75C22.25 4.6875 20.5625 3 18.5 3ZM20.75 18C20.75 19.2375 19.7375 20.25 18.5 20.25H5.75C4.5125 20.25 3.5 19.2375 3.5 18V6.75C3.5 5.5125 4.5125 4.5 5.75 4.5H18.5C19.7375 4.5 20.75 5.5125 20.75 6.75V18Z`})]),Zr=()=>(0,U.h)(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`},(0,U.h)(`g`,{transform:`translate(0 -1028.4)`},(0,U.h)(`g`,{},[(0,U.h)(`path`,{d:`m4 1031.4c-1.1046 0-2 0.9-2 2v16c0 1.1 0.8954 2 2 2h16c1.105 0 2-0.9 2-2v-16c0-1.1-0.895-2-2-2h-16z`,fill:`#d35400`}),(0,U.h)(`path`,{d:`m4 2c-1.1046 0-2 0.8954-2 2v16c0 1.105 0.8954 2 2 2h16c1.105 0 2-0.895 2-2v-16c0-1.1046-0.895-2-2-2h-16z`,transform:`translate(0 1028.4)`,fill:`#e67e22`}),(0,U.h)(`path`,{d:`m5 1034.4v2.3c6.443 0 11.667 5.2 11.667 11.7h2.333c0-7.8-6.268-14-14-14zm0 4.6v2.4c3.866 0 7 3.1 7 7h2.333c0-5.2-4.178-9.4-9.333-9.4zm2.0417 5.3c-1.1276 0-2.0417 0.9-2.0417 2s0.9141 2.1 2.0417 2.1c1.1275 0 2.0416-1 2.0416-2.1s-0.9141-2-2.0416-2z`,fill:`#d35400`}),(0,U.h)(`path`,{d:`m5 1033.4v2.3c6.443 0 11.667 5.2 11.667 11.7h2.333c0-7.8-6.268-14-14-14zm0 4.6v2.4c3.866 0 7 3.1 7 7h2.333c0-5.2-4.178-9.4-9.333-9.4zm2.0417 5.3c-1.1276 0-2.0417 0.9-2.0417 2s0.9141 2.1 2.0417 2.1c1.1275 0 2.0416-1 2.0416-2.1s-0.9141-2-2.0416-2z`,fill:`#ecf0f1`})]))),Qr=()=>(0,U.h)(`svg`,{fill:`currentColor`,width:`24`,height:`24`,viewBox:`-3 0 19 19`,class:`cf-icon-svg`},(0,U.h)(`path`,{d:`M.926 12.818a1.403 1.403 0 1 1 0 1.984 1.402 1.402 0 0 1 0-1.984zm10.531 2.357a1.03 1.03 0 0 1-1.029-1.03 8.775 8.775 0 0 0-.694-3.438A8.826 8.826 0 0 0 1.591 5.31a1.03 1.03 0 1 1 0-2.059 10.817 10.817 0 0 1 4.24.857 10.893 10.893 0 0 1 3.463 2.334 10.867 10.867 0 0 1 3.19 7.703 1.027 1.027 0 0 1-1.027 1.029zm-4.538 0a1.03 1.03 0 0 1-1.029-1.03 4.297 4.297 0 0 0-4.299-4.298 1.03 1.03 0 0 1 0-2.059 6.362 6.362 0 0 1 5.857 3.883 6.298 6.298 0 0 1 .5 2.475 1.03 1.03 0 0 1-1.029 1.029z`})),$r={key:0,class:`wl-reaction`},ei=[`textContent`],ti={class:`wl-reaction-list`},ni=[`onClick`],ri={class:`wl-reaction-img`},ii=[`src`,`alt`],ai=[`textContent`],oi=[`textContent`];var si=(0,U.defineComponent)({__name:`ArticleReaction`,setup(e){let t=kr(),n=(0,U.inject)(ge),r=(0,U.ref)(-1),i=(0,U.ref)([]),a=(0,U.computed)(()=>n.value.locale),o=(0,U.computed)(()=>{let{reaction:e}=n.value;return e?.length?e:null}),s=(0,U.computed)(()=>{let{path:e}=n.value;return o.value?.map((n,r)=>({icon:n,desc:a.value[`reaction${r}`],active:t.value[e]===r}))??null}),c,l=async()=>{let{serverURL:e,lang:t,path:r}=n.value;if(!o.value)return;let a=new AbortController;c=a.abort.bind(a);let[s]=await m({serverURL:e,lang:t,paths:[r],type:o.value.map((e,t)=>`reaction${t}`),signal:a.signal});i.value=o.value.map((e,t)=>s[`reaction${t}`])},u=async e=>{if(r.value!==-1)return;let{serverURL:a,lang:o,path:s}=n.value,c=t.value[s];r.value=e,c!=null&&(await h({serverURL:a,lang:o,path:s,type:`reaction${c}`,action:`desc`}),i.value[c]=Math.max(i.value[c]-1,0)),c!==e&&(await h({serverURL:a,lang:o,path:s,type:`reaction${e}`}),i.value[e]=(i.value[e]||0)+1),c===e?delete t.value[s]:t.value[s]=e,r.value=-1};return(0,U.onMounted)(()=>{Qe(()=>[n.value.serverURL,n.value.path],()=>l())}),(0,U.onUnmounted)(()=>{c?.()}),(e,t)=>s.value?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,$r,[(0,U.createElementVNode)(`div`,{class:`wl-reaction-title`,textContent:(0,U.toDisplayString)(a.value.reactionTitle)},null,8,ei),(0,U.createElementVNode)(`ul`,ti,[((0,U.openBlock)(!0),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)(s.value,({active:e,icon:t,desc:n},a)=>((0,U.openBlock)(),(0,U.createElementBlock)(`li`,{key:a,class:(0,U.normalizeClass)([`wl-reaction-item`,{active:e}]),onClick:e=>u(a)},[(0,U.createElementVNode)(`div`,ri,[(0,U.createElementVNode)(`img`,{src:t,alt:n},null,8,ii),r.value===a?((0,U.openBlock)(),(0,U.createBlock)((0,U.unref)(Yr),{key:0,class:`wl-reaction-loading`})):((0,U.openBlock)(),(0,U.createElementBlock)(`div`,{key:1,class:`wl-reaction-votes`,textContent:(0,U.toDisplayString)(i.value[a]||0)},null,8,ai))]),(0,U.createElementVNode)(`div`,{class:`wl-reaction-text`,textContent:(0,U.toDisplayString)(n)},null,8,oi)],10,ni))),128))])])):(0,U.createCommentVNode)(`v-if`,!0)}}),ci=u(o(((e,t)=>{(function(n,r){typeof e==`object`&&t!==void 0?t.exports=r():typeof define==`function`&&define.amd?define(r):(n||=self,n.autosize=r())})(e,(function(){var e=new Map;function t(t){if(!t||!t.nodeName||t.nodeName!==`TEXTAREA`||e.has(t))return;var n=null;function r(e){for(var t=[];e&&e.parentNode&&e.parentNode instanceof Element;)e.parentNode.scrollTop&&t.push([e.parentNode,e.parentNode.scrollTop]),e=e.parentNode;return function(){return t.forEach(function(e){var t=e[0],n=e[1];t.style.scrollBehavior=`auto`,t.scrollTop=n,t.style.scrollBehavior=null})}}var i=window.getComputedStyle(t);function a(e){var o=e.restoreTextAlign,s=o===void 0?null:o,c=e.testForHeightReduction,l=c===void 0?!0:c,u=i.overflowY;if(t.scrollHeight!==0){i.resize===`vertical`?t.style.resize=`none`:i.resize===`both`&&(t.style.resize=`horizontal`);var d;l&&(d=r(t),t.style.height=``);var f=i.boxSizing===`content-box`?t.scrollHeight-(parseFloat(i.paddingTop)+parseFloat(i.paddingBottom)):t.scrollHeight+parseFloat(i.borderTopWidth)+parseFloat(i.borderBottomWidth);if(i.maxHeight!==`none`&&f>parseFloat(i.maxHeight)?(i.overflowY===`hidden`&&(t.style.overflow=`scroll`),f=parseFloat(i.maxHeight)):i.overflowY!==`hidden`&&(t.style.overflow=`hidden`),t.style.height=f+`px`,s&&(t.style.textAlign=s),d&&d(),n!==f&&(t.dispatchEvent(new Event(`autosize:resized`,{bubbles:!0})),n=f),u!==i.overflow&&!s){var p=i.textAlign;i.overflow===`hidden`&&(t.style.textAlign=p===`start`?`end`:`start`),a({restoreTextAlign:p,testForHeightReduction:!0})}}}function o(){a({testForHeightReduction:!0,restoreTextAlign:null})}var s=function(){var e=t.value;return function(){a({testForHeightReduction:e===``||!t.value.startsWith(e),restoreTextAlign:null}),e=t.value}}(),c=function(n){t.removeEventListener(`autosize:destroy`,c),t.removeEventListener(`autosize:update`,o),t.removeEventListener(`input`,s),window.removeEventListener(`resize`,o),Object.keys(n).forEach(function(e){return t.style[e]=n[e]}),e.delete(t)}.bind(t,{height:t.style.height,resize:t.style.resize,textAlign:t.style.textAlign,overflowY:t.style.overflowY,overflowX:t.style.overflowX,wordWrap:t.style.wordWrap});t.addEventListener(`autosize:destroy`,c),t.addEventListener(`autosize:update`,o),t.addEventListener(`input`,s),window.addEventListener(`resize`,o),t.style.overflowX=`hidden`,t.style.wordWrap=`break-word`,e.set(t,{destroy:c,update:o}),o()}function n(t){var n=e.get(t);n&&n.destroy()}function r(t){var n=e.get(t);n&&n.update()}var i=null;return typeof window>`u`?(i=function(e){return e},i.destroy=function(e){return e},i.update=function(e){return e}):(i=function(e,n){return e&&Array.prototype.forEach.call(e.length?e:[e],function(e){return t(e)}),e},i.destroy=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],n),e},i.update=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],r),e}),i}))}))());const li=[`data-index`],ui=[`src`,`title`,`onClick`];var di=(0,U.defineComponent)({__name:`ImageWall`,props:{items:{default:()=>[]},columnWidth:{default:300},gap:{default:0}},emits:[`insert`],setup(e){let t=null,n=(0,U.useTemplateRef)(`wall`),r=(0,U.ref)({}),i=(0,U.ref)([]),a=()=>{let t=Math.floor((n.value.getBoundingClientRect().width+e.gap)/(e.columnWidth+e.gap));return t>0?t:1},o=e=>Array.from({length:e},()=>[]),s=async t=>{if(t>=e.items.length)return;await(0,U.nextTick)();let r=[...n.value?.children??[]].reduce((e,t)=>t.getBoundingClientRect().height<e.getBoundingClientRect().height?t:e);i.value[Number(r.dataset.index)].push(t),await s(t+1)},c=async(e=!1)=>{if(i.value.length===a()&&!e)return;i.value=o(a());let{scrollY:t}=window;await s(0),window.scrollTo({top:t})},l=e=>{r.value[e.target.src]=!0};return(0,U.onMounted)(()=>{c(!0),t=new ResizeObserver(()=>{c()}),t.observe(n.value),(0,U.watch)(()=>[e.items],()=>{r.value={},c(!0)}),(0,U.watch)(()=>[e.columnWidth,e.gap],()=>{c()})}),(0,U.onBeforeUnmount)(()=>{t.unobserve(n.value)}),(t,a)=>((0,U.openBlock)(),(0,U.createElementBlock)(`div`,{ref_key:`wall`,ref:n,class:`wl-gallery`,style:(0,U.normalizeStyle)({gap:`${e.gap}px`})},[((0,U.openBlock)(!0),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)(i.value,(n,i)=>((0,U.openBlock)(),(0,U.createElementBlock)(`div`,{key:i,class:`wl-gallery-column`,"data-index":i,style:(0,U.normalizeStyle)({gap:`${e.gap}px`})},[((0,U.openBlock)(!0),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)(n,n=>((0,U.openBlock)(),(0,U.createElementBlock)(U.Fragment,{key:n},[r.value[e.items[n].src]?(0,U.createCommentVNode)(`v-if`,!0):((0,U.openBlock)(),(0,U.createBlock)((0,U.unref)(Yr),{key:0,size:36,style:{margin:`20px auto`}})),(0,U.createElementVNode)(`img`,{class:`wl-gallery-item`,src:e.items[n].src,title:e.items[n].title,loading:`lazy`,onLoad:l,onClick:r=>t.$emit(`insert`,`![](${e.items[n].src})`)},null,40,ui)],64))),128))],12,li))),128))],4))}});const fi={key:0,class:`wl-login-info`},pi={class:`wl-avatar`},mi=[`title`],hi=[`title`],gi=[`src`],_i=[`title`,`textContent`],vi={class:`wl-panel`},yi=[`for`,`textContent`],bi=[`id`,`onUpdate:modelValue`,`name`,`type`],xi=[`placeholder`],Si={class:`wl-preview`},Ci=[`innerHTML`],wi={class:`wl-footer`},Ti={class:`wl-actions`},Ei={href:`https://guides.github.com/features/mastering-markdown/`,title:`Markdown Guide`,"aria-label":`Markdown is supported`,class:`wl-action`,target:`_blank`,rel:`noopener noreferrer`},Di=[`title`],Oi=[`title`],ki=[`title`,`aria-label`],Ai=[`title`],ji={class:`wl-info`},Mi={class:`wl-text-number`},Ni={key:0},Pi=[`textContent`],Fi=[`textContent`],Ii=[`disabled`],Li=[`placeholder`],Ri={key:1,class:`wl-loading`},zi=[`title`,`onClick`,`onMouseenter`],Bi=[`src`,`alt`],Vi=[`src`],Hi={key:0,class:`wl-tabs`},Ui=[`onClick`],Wi=[`src`,`alt`,`title`],Gi=[`title`];var Ki=(0,U.defineComponent)({__name:`CommentBox`,props:{edit:{},rootId:{},replyId:{},replyUser:{}},emits:[`log`,`cancelEdit`,`cancelReply`,`submit`],setup(e,{emit:t}){let n=e,r=t,i=(0,U.inject)(ge),a=Er(),o=Tr(),s=Lr(),c=(0,U.ref)({}),l=(0,U.useTemplateRef)(`textarea`),u=(0,U.useTemplateRef)(`image-uploader`),d=(0,U.useTemplateRef)(`emoji-button`),f=(0,U.useTemplateRef)(`emoji-popup`),p=(0,U.useTemplateRef)(`gif-button`),m=(0,U.useTemplateRef)(`gif-popup`),h=(0,U.useTemplateRef)(`gif-search`),g=(0,U.ref)({tabs:[],map:{}}),v=(0,U.ref)(0),b=(0,U.ref)(!1),x=(0,U.ref)(``),C=(0,U.ref)({}),w,T=(e,t)=>{clearTimeout(w),x.value=t;let n=e.currentTarget,r=f.value;if(n&&r){let e=n.getBoundingClientRect(),t=r.getBoundingClientRect();C.value={left:`${e.left-t.left+e.width/2}px`,top:`${e.top-t.top}px`,transform:`translate(-50%, -100%)`}}},E=()=>{w=setTimeout(()=>{x.value=``},50)},D=(0,U.ref)(!1),O=(0,U.ref)(!1),k=(0,U.ref)(``),A=(0,U.ref)(0),j=(0,U.reactive)({loading:!0,list:[]}),ee=(0,U.ref)(0),M=(0,U.ref)(!1),te=(0,U.ref)(``),N=(0,U.ref)(!1),P=(0,U.ref)(!1),F=(0,U.computed)(()=>i.value.locale),ne=(0,U.computed)(()=>!!s.value.token),I=(0,U.computed)(()=>i.value.imageUploader!=null),L=e=>{let t=l.value,n=t.selectionStart,r=t.selectionEnd||0,{scrollTop:i}=t;a.value=t.value.slice(0,n)+e+t.value.slice(r),t.focus(),t.selectionStart=n+e.length,t.selectionEnd=n+e.length,t.scrollTop=i},re=async e=>{let t=`![${i.value.locale.uploading} ${e.name}]()`;L(t),N.value=!0;try{let n=await i.value.imageUploader(e);a.value=a.value.replace(t,`\r\n![${e.name}](${n})`)}catch(e){alert(e.message),a.value=a.value.replace(t,``)}finally{N.value=!1}},ie=e=>{if(e.dataTransfer?.items){let t=Tt(e.dataTransfer.items);t&&I.value&&(re(t),e.preventDefault())}},ae=e=>{if(e.clipboardData){let t=Tt(e.clipboardData.items);t&&I.value&&re(t)}},oe=()=>{let e=u.value;e.files&&I.value&&re(e.files[0]).then(()=>{e.value=``})},R=async()=>{let{serverURL:e,lang:t,login:u,wordLimit:d,requiredMeta:f,recaptchaV3Key:p,turnstileKey:m}=i.value,h={comment:te.value,nick:o.value.nick,mail:o.value.mail,link:o.value.link,url:i.value.path,ua:await Cr()};if(!n.edit)if(s.value.token)h.nick=s.value.display_name,h.mail=s.value.email,h.link=s.value.url;else{if(u===`force`)return;if(f.includes(`nick`)&&!h.nick){c.value.nick.focus(),alert(F.value.nickError);return}if(f.includes(`mail`)&&!h.mail||h.mail&&!ke(h.mail)){c.value.mail.focus(),alert(F.value.mailError);return}h.nick||=F.value.anonymous}if(!h.comment){l.value.focus();return}if(!M.value){alert(F.value.wordHint.replace(`$0`,d[0].toString()).replace(`$1`,d[1].toString()).replace(`$2`,A.value.toString()));return}h.comment=_r(h.comment,g.value.map),n.replyId&&n.rootId&&(h.pid=n.replyId,h.rid=n.rootId,h.at=n.replyUser),N.value=!0;try{p&&(h.recaptchaV3=await Pr(p).execute(`social`)),m&&(h.turnstile=await Fr(m).execute(`social`));let i={serverURL:e,lang:t,token:s.value.token,comment:h},o=await(n.edit?y({objectId:n.edit.objectId,...i}):_(i));if(N.value=!1,o.errmsg){alert(o.errmsg);return}r(`submit`,o.data),a.value=``,k.value=``,await(0,U.nextTick)(),n.replyId&&r(`cancelReply`),n.edit?.objectId&&r(`cancelEdit`)}catch(e){N.value=!1,alert(e.message)}},se=({key:e,ctrlKey:t,metaKey:n})=>{N.value||(t||n)&&e===`Enter`&&R()},ce=e=>{e.preventDefault();let{lang:t,serverURL:n}=i.value;S({serverURL:n,lang:t}).then(e=>{s.value=e,(e.remember?localStorage:sessionStorage).setItem(`WALINE_USER`,JSON.stringify(e)),r(`log`)})},le=()=>{s.value={},localStorage.setItem(`WALINE_USER`,`null`),sessionStorage.setItem(`WALINE_USER`,`null`),r(`log`)},z=e=>{e.preventDefault();let{lang:t,serverURL:n}=i.value,r=(window.innerWidth-800)/2,a=(window.innerHeight-800)/2,o=new URLSearchParams({lng:t,token:s.value.token});window.open(`${n}/ui/profile?${o.toString()}`,`_blank`,`width=800,height=800,left=${r},top=${a},scrollbars=no,resizable=no,status=no,location=no,toolbar=no,menubar=no`)?.postMessage({type:`TOKEN`,data:s.value.token},`*`)},ue=e=>{!d.value?.contains(e.target)&&!f.value?.contains(e.target)&&(b.value=!1),!p.value?.contains(e.target)&&!m.value?.contains(e.target)&&(D.value=!1)},de=async e=>{let{scrollTop:t,clientHeight:n,scrollHeight:r}=e.target,a=(n+t)/r,o=i.value.search,s=h.value?.value??``;a<.9||j.loading||P.value||(j.loading=!0,(o.more&&j.list.length>0?await o.more(s,j.list.length):await o.search(s)).length>0?j.list=[...j.list,...o.more&&j.list.length>0?await o.more(s,j.list.length):await o.search(s)]:P.value=!0,j.loading=!1,setTimeout(()=>{e.target.scrollTop=t},50))},B=Ke(e=>{j.list=[],P.value=!1,de(e)},300);return nt(`click`,ue),nt(`message`,({data:e})=>{e?.type===`profile`&&(s.value={...s.value,...e.data},[localStorage,sessionStorage].filter(e=>e.getItem(`WALINE_USER`)).forEach(e=>{e.setItem(`WALINE_USER`,JSON.stringify(s))}))}),Qe([i,A],([e,t])=>{let{wordLimit:n}=e;n?t<n[0]&&n[0]!==0?([ee.value]=n,M.value=!1):([,ee.value]=n,M.value=t<=n[1]):(ee.value=0,M.value=!0)}),(0,U.watch)(D,async e=>{if(!e)return;let t=i.value.search;h.value&&(h.value.value=``),j.loading=!0,j.list=await(t.default?.()??t.search(``)),j.loading=!1}),(0,U.onMounted)(()=>{n.edit?.objectId&&(a.value=n.edit.orig),Qe(()=>a.value,e=>{let{highlighter:t,texRenderer:n}=i.value;te.value=e,k.value=vr(e,{emojiMap:g.value.map,highlighter:t,texRenderer:n}),A.value=Sr(e),e?(0,ci.default)(l.value):ci.default.destroy(l.value)}),Qe(()=>i.value.emoji,async e=>{g.value=await St(e)})}),(t,n)=>((0,U.openBlock)(),(0,U.createElementBlock)(`div`,{key:(0,U.unref)(s).token,class:`wl-comment`},[(0,U.unref)(i).login!==`disable`&&ne.value&&!e.edit?.objectId?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,fi,[(0,U.createElementVNode)(`div`,pi,[(0,U.createElementVNode)(`button`,{type:`submit`,class:`wl-logout-btn`,title:F.value.logout,onClick:le},[(0,U.createVNode)((0,U.unref)(zr),{size:14})],8,mi),(0,U.createElementVNode)(`a`,{href:`#`,class:`wl-login-nick`,"aria-label":`Profile`,title:F.value.profile,onClick:z},[(0,U.createElementVNode)(`img`,{src:(0,U.unref)(s).avatar,alt:`avatar`},null,8,gi)],8,hi)]),(0,U.createElementVNode)(`a`,{href:`#`,class:`wl-login-nick`,"aria-label":`Profile`,title:F.value.profile,onClick:z,textContent:(0,U.toDisplayString)((0,U.unref)(s).display_name)},null,8,_i)])):(0,U.createCommentVNode)(`v-if`,!0),(0,U.createElementVNode)(`div`,vi,[(0,U.unref)(i).login!==`force`&&(0,U.unref)(i).meta.length&&!ne.value?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,{key:0,class:(0,U.normalizeClass)([`wl-header`,`item${(0,U.unref)(i).meta.length}`])},[((0,U.openBlock)(!0),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)((0,U.unref)(i).meta,e=>((0,U.openBlock)(),(0,U.createElementBlock)(`div`,{key:e,class:`wl-header-item`},[(0,U.createElementVNode)(`label`,{for:`wl-${e}`,textContent:(0,U.toDisplayString)(F.value[e]+((0,U.unref)(i).requiredMeta.includes(e)||!(0,U.unref)(i).requiredMeta.length?``:`(${F.value.optional})`))},null,8,yi),(0,U.withDirectives)((0,U.createElementVNode)(`input`,{id:`wl-${e}`,ref_for:!0,ref:t=>{t&&(c.value[e]=t)},"onUpdate:modelValue":t=>(0,U.unref)(o)[e]=t,class:(0,U.normalizeClass)([`wl-input`,`wl-${e}`]),name:e,type:e===`mail`?`email`:`text`},null,10,bi),[[U.vModelDynamic,(0,U.unref)(o)[e]]])]))),128))],2)):(0,U.createCommentVNode)(`v-if`,!0),(0,U.withDirectives)((0,U.createElementVNode)(`textarea`,{id:`wl-edit`,ref:`textarea`,"onUpdate:modelValue":n[0]||=e=>(0,U.isRef)(a)?a.value=e:null,class:`wl-editor`,placeholder:e.replyUser?`@${e.replyUser}`:F.value.placeholder,onKeydown:se,onDrop:ie,onPaste:ae},null,40,xi),[[U.vModelText,(0,U.unref)(a)]]),(0,U.withDirectives)((0,U.createElementVNode)(`div`,Si,[n[7]||=(0,U.createElementVNode)(`hr`,null,null,-1),(0,U.createElementVNode)(`h4`,null,(0,U.toDisplayString)(F.value.preview)+`:`,1),(0,U.createElementVNode)(`div`,{class:`wl-content`,innerHTML:k.value},null,8,Ci)],512),[[U.vShow,O.value]]),(0,U.createElementVNode)(`div`,wi,[(0,U.createElementVNode)(`div`,Ti,[(0,U.createElementVNode)(`a`,Ei,[(0,U.createVNode)((0,U.unref)(Wr))]),(0,U.withDirectives)((0,U.createElementVNode)(`button`,{ref:`emoji-button`,type:`button`,class:(0,U.normalizeClass)([`wl-action`,{active:b.value}]),title:F.value.emoji,onClick:n[1]||=e=>b.value=!b.value},[(0,U.createVNode)((0,U.unref)(Vr))],10,Di),[[U.vShow,g.value.tabs.length]]),(0,U.unref)(i).search?((0,U.openBlock)(),(0,U.createElementBlock)(`button`,{key:0,ref:`gif-button`,type:`button`,class:(0,U.normalizeClass)([`wl-action`,{active:D.value}]),title:F.value.gif,onClick:n[2]||=e=>D.value=!D.value},[(0,U.createVNode)((0,U.unref)(Xr))],10,Oi)):(0,U.createCommentVNode)(`v-if`,!0),(0,U.createElementVNode)(`input`,{id:`wl-image-upload`,ref:`image-uploader`,class:`upload`,"aria-hidden":`true`,type:`file`,accept:`.png,.jpg,.jpeg,.webp,.bmp,.gif`,onChange:oe},null,544),I.value?((0,U.openBlock)(),(0,U.createElementBlock)(`label`,{key:1,for:`wl-image-upload`,class:`wl-action`,title:F.value.uploadImage,"aria-label":F.value.uploadImage},[(0,U.createVNode)((0,U.unref)(Hr))],8,ki)):(0,U.createCommentVNode)(`v-if`,!0),(0,U.createElementVNode)(`button`,{type:`button`,class:(0,U.normalizeClass)([`wl-action`,{active:O.value}]),title:F.value.preview,onClick:n[3]||=e=>O.value=!O.value},[(0,U.createVNode)((0,U.unref)(Ur))],10,Ai)]),(0,U.createElementVNode)(`div`,ji,[n[9]||=(0,U.createElementVNode)(`div`,{class:`wl-captcha-container`},null,-1),(0,U.createElementVNode)(`div`,Mi,[(0,U.createTextVNode)((0,U.toDisplayString)(A.value)+` `,1),(0,U.unref)(i).wordLimit?((0,U.openBlock)(),(0,U.createElementBlock)(`span`,Ni,[n[8]||=(0,U.createTextVNode)(` \xA0/\xA0 `,-1),(0,U.createElementVNode)(`span`,{class:(0,U.normalizeClass)({illegal:!M.value}),textContent:(0,U.toDisplayString)(ee.value)},null,10,Pi)])):(0,U.createCommentVNode)(`v-if`,!0),(0,U.createTextVNode)(` \xA0`+(0,U.toDisplayString)(F.value.word),1)]),(0,U.unref)(i).login!==`disable`&&!ne.value?((0,U.openBlock)(),(0,U.createElementBlock)(`button`,{key:0,type:`button`,class:`wl-btn`,onClick:ce,textContent:(0,U.toDisplayString)(F.value.login)},null,8,Fi)):(0,U.createCommentVNode)(`v-if`,!0),(0,U.unref)(i).login!==`force`||ne.value?((0,U.openBlock)(),(0,U.createElementBlock)(`button`,{key:1,type:`submit`,class:`primary wl-btn`,title:`Cmd|Ctrl + Enter`,disabled:N.value,onClick:R},[N.value?((0,U.openBlock)(),(0,U.createBlock)((0,U.unref)(Yr),{key:0,size:16})):((0,U.openBlock)(),(0,U.createElementBlock)(U.Fragment,{key:1},[(0,U.createTextVNode)((0,U.toDisplayString)(F.value.submit),1)],64))],8,Ii)):(0,U.createCommentVNode)(`v-if`,!0)]),(0,U.createElementVNode)(`div`,{ref:`gif-popup`,class:(0,U.normalizeClass)([`wl-gif-popup`,{display:D.value}])},[(0,U.createElementVNode)(`input`,{ref:`gif-search`,type:`text`,placeholder:F.value.gifSearchPlaceholder,onInput:n[4]||=(...e)=>(0,U.unref)(B)&&(0,U.unref)(B)(...e)},null,40,Li),j.list.length?((0,U.openBlock)(),(0,U.createBlock)(di,{key:0,items:j.list,"column-width":200,gap:6,onInsert:n[5]||=e=>L(e),onScroll:de},null,8,[`items`])):(0,U.createCommentVNode)(`v-if`,!0),j.loading?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,Ri,[(0,U.createVNode)((0,U.unref)(Yr),{size:30})])):(0,U.createCommentVNode)(`v-if`,!0)],2),(0,U.createElementVNode)(`div`,{ref:`emoji-popup`,class:(0,U.normalizeClass)([`wl-emoji-popup`,{display:b.value}])},[((0,U.openBlock)(!0),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)(g.value.tabs,(e,t)=>((0,U.openBlock)(),(0,U.createElementBlock)(U.Fragment,{key:e.name},[t===v.value?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,{key:0,class:`wl-tab-wrapper`,onScroll:E},[((0,U.openBlock)(!0),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)(e.items,e=>((0,U.openBlock)(),(0,U.createElementBlock)(`button`,{key:e,type:`button`,title:e,onClick:t=>L(`:${e}:`),onMouseenter:t=>T(t,e),onMouseleave:E},[b.value?((0,U.openBlock)(),(0,U.createElementBlock)(`img`,{key:0,class:`wl-emoji`,src:g.value.map[e],alt:e,loading:`lazy`,referrerPolicy:`no-referrer`},null,8,Bi)):(0,U.createCommentVNode)(`v-if`,!0)],40,zi))),128))],32)):(0,U.createCommentVNode)(`v-if`,!0)],64))),128)),(0,U.createElementVNode)(`div`,null,[x.value?((0,U.openBlock)(),(0,U.createElementBlock)(`img`,{key:0,class:`wl-emoji-preview`,src:g.value.map[x.value],alt:`preview`,loading:`lazy`,referrerPolicy:`no-referrer`,style:(0,U.normalizeStyle)(C.value)},null,12,Vi)):(0,U.createCommentVNode)(`v-if`,!0)]),g.value.tabs.length>1?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,Hi,[((0,U.openBlock)(!0),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)(g.value.tabs,(e,t)=>((0,U.openBlock)(),(0,U.createElementBlock)(`button`,{key:e.name,type:`button`,class:(0,U.normalizeClass)([`wl-tab`,{active:v.value===t}]),onClick:e=>v.value=t},[(0,U.createElementVNode)(`img`,{class:`wl-emoji`,src:e.icon,alt:e.name,title:e.name,loading:`lazy`,referrerPolicy:`no-referrer`},null,8,Wi)],10,Ui))),128))])):(0,U.createCommentVNode)(`v-if`,!0)],2)])]),e.replyId||e.edit?.objectId?((0,U.openBlock)(),(0,U.createElementBlock)(`button`,{key:1,type:`button`,class:`wl-close`,title:F.value.cancelReply,onClick:n[6]||=t=>e.replyId?r(`cancelReply`):r(`cancelEdit`)},[(0,U.createVNode)((0,U.unref)(zr),{size:24})],8,Gi)):(0,U.createCommentVNode)(`v-if`,!0)]))}});const qi=[`id`],Ji={class:`wl-user`,"aria-hidden":`true`},Yi=[`src`],Xi={class:`wl-card`},Zi={class:`wl-head`},Qi=[`href`],$i={key:1,class:`wl-nick`},ea=[`textContent`],ta=[`textContent`],na=[`textContent`],ra=[`textContent`],ia={class:`wl-comment-actions`},aa=[`title`,`href`],oa=[`title`],sa=[`title`],ca={class:`wl-meta`,"aria-hidden":`true`},la=[`data-value`,`textContent`],ua={key:0,class:`wl-warning`,"aria-hidden":`true`},da={key:1,class:`wl-content`},fa={key:0,class:`wl-reply-to`},pa=[`href`],ma=[`innerHTML`],ha={key:2,class:`wl-admin-actions`},ga={class:`wl-comment-status`},_a=[`disabled`,`onClick`,`textContent`],va={key:4,class:`wl-quote`};var ya=(0,U.defineComponent)({__name:`CommentCard`,props:{comment:{},edit:{},rootId:{},reply:{}},emits:[`log`,`submit`,`delete`,`like`,`sticky`,`edit`,`reply`,`status`],setup(e,{emit:t}){let n=t,r=[`approved`,`waiting`,`spam`],i=(0,U.inject)(ge),a=Dr(),o=mt(),s=Lr(),c=(0,U.computed)(()=>i.value.locale),l=(0,U.computed)(()=>{let{link:t}=e.comment;return t?ye(t)?t:`https://${t}`:``}),u=(0,U.computed)(()=>a.value.includes(e.comment.objectId)),d=(0,U.computed)(()=>De(new Date(e.comment.time),o.value,c.value)),f=(0,U.computed)(()=>s.value.type===`administrator`),p=(0,U.computed)(()=>e.comment.user_id&&s.value.objectId===e.comment.user_id),m=(0,U.computed)(()=>e.comment.objectId===e.reply?.objectId),h=(0,U.computed)(()=>e.comment.objectId===e.edit?.objectId);return(t,a)=>{let o=(0,U.resolveComponent)(`CommentCard`,!0);return(0,U.openBlock)(),(0,U.createElementBlock)(`div`,{id:e.comment.objectId.toString(),class:`wl-card-item`},[(0,U.createElementVNode)(`div`,Ji,[e.comment.avatar?((0,U.openBlock)(),(0,U.createElementBlock)(`img`,{key:0,class:`wl-user-avatar`,src:e.comment.avatar,alt:``},null,8,Yi)):(0,U.createCommentVNode)(`v-if`,!0),e.comment.type===`guest`?((0,U.openBlock)(),(0,U.createBlock)((0,U.unref)(qr),{key:1})):(0,U.createCommentVNode)(`v-if`,!0),e.comment.type===`administrator`?((0,U.openBlock)(),(0,U.createBlock)((0,U.unref)(Jr),{key:2})):(0,U.createCommentVNode)(`v-if`,!0)]),(0,U.createElementVNode)(`div`,Xi,[(0,U.createElementVNode)(`div`,Zi,[l.value?((0,U.openBlock)(),(0,U.createElementBlock)(`a`,{key:0,class:`wl-nick`,href:l.value,target:`_blank`,rel:`ugc nofollow noreferrer noopener`},(0,U.toDisplayString)(e.comment.nick),9,Qi)):((0,U.openBlock)(),(0,U.createElementBlock)(`span`,$i,(0,U.toDisplayString)(e.comment.nick),1)),e.comment.label?((0,U.openBlock)(),(0,U.createElementBlock)(`span`,{key:2,class:`wl-badge`,textContent:(0,U.toDisplayString)(e.comment.label)},null,8,ea)):(0,U.createCommentVNode)(`v-if`,!0),e.comment.sticky?((0,U.openBlock)(),(0,U.createElementBlock)(`span`,{key:3,class:`wl-badge`,textContent:(0,U.toDisplayString)(c.value.sticky)},null,8,ta)):(0,U.createCommentVNode)(`v-if`,!0),typeof e.comment.level==`number`?((0,U.openBlock)(),(0,U.createElementBlock)(`span`,{key:4,class:(0,U.normalizeClass)(`wl-badge level${e.comment.level}`),textContent:(0,U.toDisplayString)(c.value[`level${e.comment.level}`]||`Level ${e.comment.level}`)},null,10,na)):(0,U.createCommentVNode)(`v-if`,!0),(0,U.createElementVNode)(`span`,{class:`wl-time`,textContent:(0,U.toDisplayString)(d.value)},null,8,ra),(0,U.createElementVNode)(`div`,ia,[f.value||p.value?((0,U.openBlock)(),(0,U.createElementBlock)(U.Fragment,{key:0},[(0,U.createElementVNode)(`button`,{type:`button`,class:`wl-edit`,onClick:a[0]||=t=>n(`edit`,e.comment)},[(0,U.createVNode)((0,U.unref)(Kr))]),(0,U.createElementVNode)(`button`,{type:`button`,class:`wl-delete`,onClick:a[1]||=t=>n(`delete`,e.comment)},[(0,U.createVNode)((0,U.unref)(Br))])],64)):(0,U.createCommentVNode)(`v-if`,!0),p.value&&!(0,U.unref)(i).noRss?((0,U.openBlock)(),(0,U.createElementBlock)(`a`,{key:1,role:`button`,class:`wl-rss`,title:c.value.subscribeToReplies,href:`${(0,U.unref)(i).serverURL}/api/comment/rss?user_id=${e.comment.user_id}`,target:`_blank`,rel:`noopener noreferrer`},[(0,U.createVNode)((0,U.unref)(Qr))],8,aa)):(0,U.createCommentVNode)(`v-if`,!0),(0,U.createElementVNode)(`button`,{type:`button`,class:`wl-like`,title:u.value?c.value.cancelLike:c.value.like,onClick:a[2]||=t=>n(`like`,e.comment)},[(0,U.createVNode)((0,U.unref)($),{active:u.value},null,8,[`active`]),(0,U.createTextVNode)(` `+(0,U.toDisplayString)(`like`in e.comment?e.comment.like:``),1)],8,oa),(0,U.createElementVNode)(`button`,{type:`button`,class:(0,U.normalizeClass)([`wl-reply`,{active:m.value}]),title:m.value?c.value.cancelReply:c.value.reply,onClick:a[3]||=t=>n(`reply`,m.value?null:e.comment)},[(0,U.createVNode)((0,U.unref)(Gr))],10,sa)])]),(0,U.createElementVNode)(`div`,ca,[((0,U.openBlock)(),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)([`addr`,`browser`,`os`],t=>((0,U.openBlock)(),(0,U.createElementBlock)(U.Fragment,null,[e.comment[t]?((0,U.openBlock)(),(0,U.createElementBlock)(`span`,{key:t,class:(0,U.normalizeClass)(`wl-${t}`),"data-value":e.comment[t],textContent:(0,U.toDisplayString)(e.comment[t])},null,10,la)):(0,U.createCommentVNode)(`v-if`,!0)],64))),64))]),e.comment.status===`waiting`&&!f.value?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,ua,(0,U.toDisplayString)(c.value.commentUnderReview),1)):(0,U.createCommentVNode)(`v-if`,!0),h.value?(0,U.createCommentVNode)(`v-if`,!0):((0,U.openBlock)(),(0,U.createElementBlock)(`div`,da,[`reply_user`in e.comment&&e.comment.reply_user?((0,U.openBlock)(),(0,U.createElementBlock)(`p`,fa,[(0,U.createElementVNode)(`a`,{href:`#`+e.comment.pid},`@`+(0,U.toDisplayString)(e.comment.reply_user.nick),9,pa),a[17]||=(0,U.createElementVNode)(`span`,null,`: `,-1)])):(0,U.createCommentVNode)(`v-if`,!0),(0,U.createElementVNode)(`div`,{innerHTML:e.comment.comment},null,8,ma)])),f.value&&!h.value?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,ha,[(0,U.createElementVNode)(`span`,ga,[((0,U.openBlock)(),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)(r,t=>(0,U.createElementVNode)(`button`,{key:t,type:`submit`,class:(0,U.normalizeClass)(`wl-btn wl-${t}`),disabled:e.comment.status===t,onClick:r=>n(`status`,{status:t,comment:e.comment}),textContent:(0,U.toDisplayString)(c.value[t])},null,10,_a)),64))]),f.value&&!(`rid`in e.comment)?((0,U.openBlock)(),(0,U.createElementBlock)(`button`,{key:0,type:`submit`,class:`wl-btn wl-sticky`,onClick:a[4]||=t=>n(`sticky`,e.comment)},(0,U.toDisplayString)(e.comment.sticky?c.value.unsticky:c.value.sticky),1)):(0,U.createCommentVNode)(`v-if`,!0)])):(0,U.createCommentVNode)(`v-if`,!0),m.value||h.value?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,{key:3,class:(0,U.normalizeClass)({"wl-reply-wrapper":m.value,"wl-edit-wrapper":h.value})},[(0,U.createVNode)(Ki,{edit:e.edit,"reply-id":e.reply?.objectId,"reply-user":e.comment.nick,"root-id":e.rootId,onLog:a[5]||=e=>n(`log`),onCancelReply:a[6]||=e=>n(`reply`,null),onCancelEdit:a[7]||=e=>n(`edit`,null),onSubmit:a[8]||=e=>n(`submit`,e)},null,8,[`edit`,`reply-id`,`reply-user`,`root-id`])],2)):(0,U.createCommentVNode)(`v-if`,!0),`children`in e.comment?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,va,[((0,U.openBlock)(!0),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)(e.comment.children,t=>((0,U.openBlock)(),(0,U.createBlock)(o,{key:t.objectId,comment:t,reply:e.reply,edit:e.edit,"root-id":e.rootId,onLog:a[9]||=e=>n(`log`),onDelete:a[10]||=e=>n(`delete`,e),onEdit:a[11]||=e=>n(`edit`,e),onLike:a[12]||=e=>n(`like`,e),onReply:a[13]||=e=>n(`reply`,e),onStatus:a[14]||=e=>n(`status`,e),onSticky:a[15]||=e=>n(`sticky`,e),onSubmit:a[16]||=e=>n(`submit`,e)},null,8,[`comment`,`reply`,`edit`,`root-id`]))),128))])):(0,U.createCommentVNode)(`v-if`,!0)])],8,qi)}}});const ba={"data-waline":``},xa={class:`wl-meta-head`},Sa={class:`wl-count`},Ca=[`textContent`],wa={class:`wl-sort`},Ta=[`onClick`],Ea={class:`wl-cards`},Da={key:1,class:`wl-operation`},Oa=[`textContent`],ka={key:2,class:`wl-loading`},Aa=[`textContent`],ja={key:4,class:`wl-operation`},Ma=[`textContent`],Na={key:5,class:`wl-meta-foot`},Pa={key:0,class:`wl-rss`},Fa=[`href`,`alt`],Ia=[`textContent`],La=[`href`,`alt`],Ra=[`textContent`],za={key:1,class:`wl-power`};var Ba=(0,U.defineComponent)({__name:`WalineComment`,props:{serverURL:{},path:{},meta:{},requiredMeta:{},wordLimit:{},pageSize:{},lang:{},locale:{},commentSorting:{},dark:{type:[String,Boolean]},login:{},noCopyright:{type:Boolean},noRss:{type:Boolean},recaptchaV3Key:{},turnstileKey:{},reaction:{type:[Array,Boolean]},emoji:{},search:{type:[Object,Boolean]},highlighter:{type:Function},imageUploader:{type:Function},texRenderer:{type:Function}},setup(e){let t=e,n=Lr(),r=Dr(),i=(0,U.ref)(`loading`),a=(0,U.ref)(0),o=(0,U.ref)(1),s=(0,U.ref)(0),c=(0,U.computed)(()=>Se(t)),l=(0,U.ref)(c.value.commentSorting),u=(0,U.ref)([]),d=(0,U.ref)(null),f=(0,U.ref)(null),p=(0,U.computed)(()=>we(c.value.dark)),m=(0,U.computed)(()=>c.value.locale);_t(p,{id:`waline-darkmode`});let h=null,_=e=>{let{serverURL:t,path:r,pageSize:d}=c.value,f=new AbortController;i.value=`loading`,h?.(),g({serverURL:t,lang:c.value.lang,path:r,pageSize:d,sortBy:me[l.value],page:e,signal:f.signal,token:n.value.token}).then(t=>{i.value=`success`,a.value=t.count,u.value.push(...t.data),o.value=e,s.value=t.totalPages}).catch(e=>{e.name!==`AbortError`&&(console.error(e.message),i.value=`error`)}),h=f.abort.bind(f)},b=()=>{_(o.value+1)},x=()=>{a.value=0,u.value=[],_(1)},S=e=>{l.value!==e&&(l.value=e,x())},C=e=>{d.value=e},w=e=>{f.value=e},T=e=>{if(f.value)f.value.comment=e.comment,f.value.orig=e.orig;else if(`rid`in e){let t=u.value.find(({objectId:t})=>t===e.rid);if(!t)return;Array.isArray(t.children)||(t.children=[]),t.children.push(e)}else u.value.unshift(e),a.value+=1},E=async({comment:e,status:t})=>{if(e.status===t)return;let{serverURL:r,lang:i}=c.value;await y({serverURL:r,lang:i,token:n.value.token,objectId:e.objectId,comment:{status:t}}),e.status=t},D=async e=>{if(`rid`in e)return;let{serverURL:t,lang:r}=c.value;await y({serverURL:t,lang:r,token:n.value.token,objectId:e.objectId,comment:{sticky:+!e.sticky}}),e.sticky=!e.sticky},O=async({objectId:e})=>{if(!confirm(`Are you sure you want to delete this comment?`))return;let{serverURL:t,lang:r}=c.value;await v({serverURL:t,lang:r,token:n.value.token,objectId:e}),u.value.some((t,n)=>t.objectId===e?(u.value=u.value.filter((e,t)=>t!==n),!0):t.children.some((r,i)=>r.objectId===e?(u.value[n].children=t.children.filter((e,t)=>t!==i),!0):!1))},k=async e=>{let{serverURL:t,lang:i}=c.value,{objectId:a}=e,o=r.value.includes(a);await y({serverURL:t,lang:i,objectId:a,token:n.value.token,comment:{like:!o}}),o?r.value=r.value.filter(e=>e!==a):(r.value=[...r.value,a],r.value.length>50&&(r.value=r.value.slice(-50))),e.like=Math.max(0,(e.like||0)+(o?-1:1))};return(0,U.provide)(ge,c),(0,U.onMounted)(async()=>{Qe(()=>[t.serverURL,t.path],()=>{x()});let e=new URLSearchParams(location.search).get(`token`);if(!e)return;let r=await fetch(`${c?.value.serverURL}/token`,{headers:{Authorization:`Bearer ${e}`}}).then(e=>e.json()).catch(e=>(console.error(e),{}));!r.errno&&r?.data?.objectId&&(n.value={...r.data,token:e});let i=new URL(window.location.href);i.searchParams.delete(`token`),history.replaceState(null,``,i.pathname+(i.searchParams.toString()?`?${i.searchParams.toString()}`:``)+i.hash)}),(0,U.onUnmounted)(()=>{h?.()}),(e,t)=>((0,U.openBlock)(),(0,U.createElementBlock)(`div`,ba,[(0,U.createVNode)(si),!d.value&&!f.value?((0,U.openBlock)(),(0,U.createBlock)(Ki,{key:0,onLog:x,onSubmit:T})):(0,U.createCommentVNode)(`v-if`,!0),(0,U.createElementVNode)(`div`,xa,[(0,U.createElementVNode)(`div`,Sa,[a.value?((0,U.openBlock)(),(0,U.createElementBlock)(`span`,{key:0,class:`wl-num`,textContent:(0,U.toDisplayString)(a.value)},null,8,Ca)):(0,U.createCommentVNode)(`v-if`,!0),(0,U.createTextVNode)(` `+(0,U.toDisplayString)(m.value.comment),1)]),(0,U.createElementVNode)(`ul`,wa,[((0,U.openBlock)(!0),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)((0,U.unref)(he),e=>((0,U.openBlock)(),(0,U.createElementBlock)(`li`,{key:e,class:(0,U.normalizeClass)([e===l.value?`active`:``]),onClick:t=>S(e)},(0,U.toDisplayString)(m.value[e]),11,Ta))),128))])]),(0,U.createElementVNode)(`div`,Ea,[((0,U.openBlock)(!0),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)(u.value,e=>((0,U.openBlock)(),(0,U.createBlock)(ya,{key:e.objectId,"root-id":e.objectId,comment:e,reply:d.value,edit:f.value,onLog:x,onReply:C,onEdit:w,onSubmit:T,onStatus:E,onDelete:O,onSticky:D,onLike:k},null,8,[`root-id`,`comment`,`reply`,`edit`]))),128))]),i.value===`error`?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,Da,[(0,U.createElementVNode)(`button`,{type:`button`,class:`wl-btn`,onClick:x,textContent:(0,U.toDisplayString)(m.value.refresh)},null,8,Oa)])):i.value===`loading`?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,ka,[(0,U.createVNode)((0,U.unref)(Yr),{size:30})])):u.value.length?o.value<s.value?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,ja,[(0,U.createElementVNode)(`button`,{type:`button`,class:`wl-btn`,onClick:b,textContent:(0,U.toDisplayString)(m.value.more)},null,8,Ma)])):(0,U.createCommentVNode)(`v-if`,!0):((0,U.openBlock)(),(0,U.createElementBlock)(`div`,{key:3,class:`wl-empty`,textContent:(0,U.toDisplayString)(m.value.sofa)},null,8,Aa)),u.value.length||i.value!==`loading`?((0,U.openBlock)(),(0,U.createElementBlock)(`div`,Na,[c.value.noRss?(0,U.createCommentVNode)(`v-if`,!0):((0,U.openBlock)(),(0,U.createElementBlock)(`div`,Pa,[(0,U.createElementVNode)(`a`,{href:`${c.value.serverURL}/api/comment/rss?path=${encodeURIComponent(c.value.path)}`,target:`_blank`,rel:`noopener noreferrer`,alt:m.value.subPostComment},[(0,U.createVNode)((0,U.unref)(Zr)),(0,U.createElementVNode)(`span`,{textContent:(0,U.toDisplayString)(m.value.subPostComment)},null,8,Ia)],8,Fa),(0,U.createElementVNode)(`a`,{href:`${c.value.serverURL}/api/comment/rss`,target:`_blank`,rel:`noopener noreferrer`,alt:m.value.subSiteComment},[(0,U.createVNode)((0,U.unref)(Zr)),(0,U.createElementVNode)(`span`,{textContent:(0,U.toDisplayString)(m.value.subSiteComment)},null,8,Ra)],8,La)])),c.value.noCopyright?(0,U.createCommentVNode)(`v-if`,!0):((0,U.openBlock)(),(0,U.createElementBlock)(`div`,za,[t[0]||=(0,U.createTextVNode)(` Powered by `,-1),t[1]||=(0,U.createElementVNode)(`a`,{href:`https://github.com/walinejs/waline`,target:`_blank`,rel:`noopener noreferrer`},` Waline `,-1),(0,U.createTextVNode)(` v`+(0,U.toDisplayString)((0,U.unref)(Rr)),1)]))])):(0,U.createCommentVNode)(`v-if`,!0)]))}});const Va=(e,t)=>{t.forEach((t,n)=>{let r=e[n].time;typeof r==`number`&&(t.textContent=r.toString())})},Ha=({serverURL:e,path:t=window.location.pathname,selector:n=`.waline-pageview-count`,update:r=!0,lang:i=navigator.language})=>{let a=new AbortController,o=[...document.querySelectorAll(n)],s=e=>{let n=yr(e);return n!=null&&t!==n},c=n=>C({serverURL:be(e),paths:n.map(e=>yr(e)??t),lang:i,signal:a.signal}).then(e=>{Va(e,n)}).catch(Ct);if(r){let n=o.filter(e=>!s(e)),r=o.filter(e=>s(e));w({serverURL:be(e),path:t,lang:i}).then(e=>{Va(e,n)}),r.length>0&&c(r)}else c(o);return a.abort.bind(a)},Ua=({el:e=`#waline`,path:t=window.location.pathname,comment:n=!1,pageview:r=!1,...i})=>{let a=e?wt(e):null;if(e&&!a)throw Error(`Option 'el' do not match any domElement!`);if(!i.serverURL)throw Error(`Option 'serverURL' is missing!`);let o=(0,U.reactive)({...i}),s=(0,U.reactive)({comment:n,pageview:r,path:t}),c=()=>{s.comment&&wr({serverURL:o.serverURL,path:s.path,...Ce(s.comment)?{selector:s.comment}:{}})},l=()=>{s.pageview&&Ha({serverURL:o.serverURL,path:s.path,...Ce(s.pageview)?{selector:s.pageview}:{}})},u=null;a&&(u=(0,U.createApp)(()=>(0,U.h)(Ba,{path:s.path,...o})),u.mount(a));let d=(0,U.watchEffect)(c),f=(0,U.watchEffect)(l);return{el:a,update:({comment:e,pageview:t,path:n=window.location.pathname,...r}={})=>{Object.entries(r).forEach(([e,t])=>{o[e]=t}),s.path=n,e!=null&&(s.comment=e),t!=null&&(s.pageview=t)},destroy:()=>{u?.unmount(),d(),f()}}},Wa=({el:e,serverURL:t,count:n,lang:r=navigator.language})=>{let i=Lr(),a=wt(e),o=new AbortController;return T({serverURL:t,count:n,lang:r,signal:o.signal,token:i.value.token}).then(e=>a&&e.length>0?(a.innerHTML=`<ul class="wl-recent-list">${e.map(e=>`<li class="wl-recent-item"><a href="${e.url}">${e.nick}</a>：${e.comment}</li>`).join(``)}</ul>`,{comments:e,destroy:()=>{o.abort(),a.innerHTML=``}}):{comments:e,destroy:()=>{o.abort()}})},Ga=({el:e,serverURL:t,count:n,locale:r,lang:i=navigator.language,mode:a=`list`})=>{let o=wt(e),s=new AbortController;return E({serverURL:t,pageSize:n,lang:i,signal:s.signal}).then(e=>{if(!o||e.length===0)return{users:e,destroy:()=>{s.abort()}};let t={...fe(i),...typeof r==`object`?r:{}};return o.innerHTML=`<ul class="wl-user-${a}">${e.map((e,n)=>[`<li class="wl-user-item" aria-label="${e.nick}">`,e.link?`<a href="${e.link}" target="_blank">`:``,`<div class="wl-user-avatar">`,`<img src="${e.avatar}" alt="${e.nick}">`,`<span class="wl-user-badge">${n+1}</span>`,`</div>`,`<div class="wl-user-meta">`,`<div class="wl-user-name">`,e.nick,typeof e.level==`number`?`<span class="wl-badge">${t[`level${e.level}`]??`Level ${e.level}`}</span>`:``,e.label?`<span class="wl-badge">${e.label}</span>`:``,`</div>`,e.link,`</div>`,e.link?`</a>`:``,`</li>`].filter(Boolean).join(``)).join(``)}</ul>`,{users:e,destroy:()=>{s.abort(),o.innerHTML=``}}})},Ka=async({serverURL:e,lang:t,path:n})=>{let r=[1,2,3,4,5],i=new AbortController,a=i.abort.bind(i),[o]=await m({serverURL:e,lang:t,paths:[n],type:Array.from({length:5},(e,t)=>`reaction${t}`),signal:i.signal});return{value:r.map((e,t)=>o[`reaction${t}`]),abort:a}},qa=e=>Number.isNaN(e)?0:Math.min(5,Math.max(0,Math.round(e))),Ja=(e=[])=>Array.from({length:5},(t,n)=>{let r=e[n]??0;return typeof r==`number`&&r>0?r:0}),Ya={class:`wl-star-icon`,viewBox:`0 0 24 24`};var Xa=(0,U.defineComponent)({__name:`WalineStarDisplay`,props:{score:{default:0}},setup(e){let t=(0,U.computed)(()=>qa(e.score)),n=e=>t.value>=e?`wl-star-solid`:`wl-star-outline`;return(e,t)=>((0,U.openBlock)(),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)([1,2,3,4,5],e=>(0,U.createElementVNode)(`span`,{key:e,class:`wl-star-item`},[((0,U.openBlock)(),(0,U.createElementBlock)(`svg`,Ya,[(0,U.createElementVNode)(`path`,{class:(0,U.normalizeClass)(n(e)),d:`M12 2l3.09 6.26L22 9.27l-5 4.87L18.18 22 12 18.56 5.82 22 7 14.14l-5-4.87 6.91-1.01L12 2z`},null,2)]))])),64))}});const Za={class:`wl-star`},Qa={class:`wl-star-score`},$a={class:`wl-star-rate`},eo={class:`wl-star-progress`},to=[`data-count`],no={class:`wl-star-percent`};var ro=(0,U.defineComponent)({__name:`WalineStarWidget`,props:{serverURL:{},lang:{},path:{}},emits:[`rate`],setup(e,{emit:t}){let n=e,r=t,i=(0,U.ref)(null),a=kr(),o=(0,U.ref)(qa((a.value[n.path]??0)+1)),s=(0,U.ref)(null),c=(0,U.ref)(Ja([])),l=(0,U.ref)(!1);(0,U.onMounted)(()=>{Qe(()=>[n.serverURL,n.path],async()=>{try{c.value=Ja((await Ka(n)).value)}catch(e){console.error(`Failed to fetch reaction data:`,e)}})});let u=(0,U.computed)(()=>s.value??o.value),d=(0,U.computed)(()=>c.value.reduce((e,t)=>e+t,0)),f=(0,U.computed)(()=>c.value.map(e=>d.value?e/d.value:0)),p=e=>{if(!i.value)return 0;let{firstElementChild:t,lastElementChild:n}=i.value;if(!t||!n)return 0;let{left:r}=t.getBoundingClientRect(),{right:a}=n.getBoundingClientRect(),o=a-r,s=(e.clientX-r)/o;return qa(Math.min(1,Math.max(0,s))*5)},m=e=>{s.value=p(e)},g=()=>{s.value=null},_=async e=>{let t=s.value??p(e);if(t===o.value||l.value)return;l.value=!0;let i=o.value;try{i&&(await h({...n,type:`reaction${i-1}`,action:`desc`}),c.value[i-1]=Math.max(0,(c.value[i-1]??0)-1)),o.value=t;let e=t-1;a.value[n.path]=e,await h({...n,type:`reaction${e}`,action:`inc`}),c.value[e]=(c.value[e]??0)+1,r(`rate`,t)}catch(e){o.value=i,i?a.value[n.path]=i-1:delete a.value[n.path],console.error(`[Waline] Failed to update reaction counter`,e)}finally{l.value=!1}},v=e=>c.value[e-1]??0,y=e=>`${((f.value[e-1]??0)*100).toFixed(1)}%`;return(e,t)=>((0,U.openBlock)(),(0,U.createElementBlock)(`div`,Za,[(0,U.createElementVNode)(`div`,{ref_key:`ratingArea`,ref:i,class:`wl-star-rate`,onMousemove:m,onMouseleave:g,onClick:_},[(0,U.createVNode)(Xa,{score:u.value},null,8,[`score`])],544),(0,U.createElementVNode)(`div`,Qa,[((0,U.openBlock)(),(0,U.createElementBlock)(U.Fragment,null,(0,U.renderList)([5,4,3,2,1],e=>(0,U.createElementVNode)(`div`,{key:e,class:`wl-star-row`},[(0,U.createElementVNode)(`div`,$a,[(0,U.createVNode)(Xa,{score:e},null,8,[`score`])]),(0,U.createElementVNode)(`div`,eo,[(0,U.createElementVNode)(`div`,{class:`wl-star-progress-bar`,style:(0,U.normalizeStyle)({width:y(e)}),"data-count":v(e).toString()},null,12,to)]),(0,U.createElementVNode)(`span`,no,(0,U.toDisplayString)(y(e)),1)])),64))])]))}});const io=({el:e,path:t,lang:n=navigator.language,serverURL:r,onRate:i})=>{let a=wt(e);if(!a)return{destroy:()=>{}};let o=(0,U.createApp)(ro,{path:t,lang:n,serverURL:r,onRate:i});return o.mount(a),{destroy:()=>{o.unmount(),a.innerHTML=``}}};export{Wa as RecentComments,io as Star,Ga as UserList,_ as addComment,wr as commentCount,B as defaultLocales,v as deleteComment,b as fetchCommentCount,m as getArticleCounter,g as getComment,C as getPageview,T as getRecentComment,E as getUserList,Ua as init,S as login,Ha as pageviewCount,h as updateArticleCounter,y as updateComment,w as updatePageview,Rr as version};
